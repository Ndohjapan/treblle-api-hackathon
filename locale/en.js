module.exports = {
  ...
  req_header_not_accepted: "Request header Content-Type must be application/json",
  signup_successful: "Signup Successful",
  user_not_found: "User not found",
  user_connection_already_exists: "User Connection already exists between users",
  user_connection_creation_error: "Cannot create user connection",
  message_creation_error: "Cannot create message",
  user_connection_error_same_ids: "Cannot create connection between same user",
  user_connection_find_error: "Cannot find user connection",
  message_delete_error: "Cannot delete message",
  message_find_error: "Cannot find messages",
  messageId_format: "This is not a valid message id",
  user_connection_not_found: "Cannot find user connection",
  user_creation_error: "Cannot create user",
